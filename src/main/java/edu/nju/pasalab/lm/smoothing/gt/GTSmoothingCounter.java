 ...
 */
public class GTSmoothingCounter {

    public GTSmoothingCounter() {

    }

    public static void buildFreq2Freq (String inputCorpus, int n, parameters ep) throws Exception {
        String temp = FileName.getGTFreq2Freq(ep.lmRootDir, n);
        ...
        job.setMapperClass(GTSmoothingCounter.gtMapper.class);
        job.setCombinerClass(GTSmoothingCounter.gtReducer.class);
        job.setReducerClass(GTSmoothingCounter.gtCombiner.class);
    ...
    public static class gtMapper extends Mapper<LongWritable, Text, Text, LongWritable> {
    ...
    public static class gtCombiner extends Reducer<Text, LongWritable, Text, LongWritable> {
    ...
    public static class gtReducer extends Reducer<Text, LongWritable, Text, LongWritable> {
