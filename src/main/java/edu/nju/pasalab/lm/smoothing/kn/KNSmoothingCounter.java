 ...
 */
public class KNSmoothingCounter {
    public KNSmoothingCounter() {
    ...
    public static void buildFreq2Freq (String inputCorpus, int n, parameters ep) throws Exception {
        ...
        job.setMapperClass(KNSmoothingCounter.knMapper.class);
        job.setCombinerClass(KNSmoothingCounter.knReducer.class);
        job.setReducerClass(KNSmoothingCounter.knCombiner.class);
    ...
    public static class knMapper extends Mapper<LongWritable, Text, Text, LongWritable> {
    ...
    public static class knCombiner extends Reducer<Text, LongWritable, Text, LongWritable> {
    ...
    public static class knReducer extends Reducer<Text, LongWritable, Text, LongWritable> {
